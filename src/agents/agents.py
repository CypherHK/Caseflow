...
from agents.caseflow_agent import caseflow_agent
...
agents: dict[str, Agent] = {
    "caseflow-agent": Agent(
        description="A business support agent for customer service and ticket collaboration.",
        graph_like=caseflow_agent,
    ),
...
def set_agent_graph(agent_id: str, graph_like: AgentGraphLike) -> None:
    """Replace a loaded agent graph in the in-process registry."""
    agents[agent_id].graph_like = graph_like
